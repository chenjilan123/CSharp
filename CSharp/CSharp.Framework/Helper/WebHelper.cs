       ...
       /// <returns></returns>
        public static string TakeMethodPost(string url, string urlparames, Dictionary<string, string> head, bool bNeedCompress, int iCompressLimit = 3, string sContentType = "application/x-www-form-urlencoded;charset=utf-8", WebProxy proxyObject = null)
        {
            ...
            try
            {
                ...
                //}
                //GlobalLib.Logger.Debug(string.Format("Request Url :{0} Content:\r\n{1} \r\n SLS:{2}", url, urlparames, bSLS));
        ...
        public static string TakeMethodPostWithLog(string url, string urlparames, Dictionary<string, string> head = null, string sContentType = "application/x-www-form-urlencoded;charset=utf-8")
        {
            return TakeMethodPost(url, urlparames, head, false, 10, sContentType, null);
        }
        ...
        /// <returns></returns>
        public static string TakeMethodGet(string Url, string type = "utf-8")
        {
            try
            {
        ...
        /// <returns></returns>
        public static string GetParamesString(string url,Dictionary<string, string> parames)
        {
