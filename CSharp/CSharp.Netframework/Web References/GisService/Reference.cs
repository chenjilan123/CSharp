...
namespace CSharp.NetFramework.GisService {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="MapServiceSoap", Namespace="http://tempuri.org/")]
    public partial class MapService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback OutInAreaStatisticOperationCompleted;
        ...
        /// <remarks/>
        public MapService() {
            this.Url = global::CSharp.NetFramework.Properties.Settings.Default.CSharp_NetFramework_GisService_MapService;
        ...
        /// <remarks/>
        public event OutInAreaStatisticCompletedEventHandler OutInAreaStatisticCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/OutInAreaStatistic", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public string OutInAreaStatistic(string[] trackData, string[] areaData) {
            object[] results = this.Invoke("OutInAreaStatistic", new object[] {
                        trackData,
                        areaData});
            return ((string)(results[0]));
        }
        ...
        /// <remarks/>
        public void OutInAreaStatisticAsync(string[] trackData, string[] areaData) {
            this.OutInAreaStatisticAsync(trackData, areaData, null);
        }
        
        /// <remarks/>
        public void OutInAreaStatisticAsync(string[] trackData, string[] areaData, object userState) {
            if ((this.OutInAreaStatisticOperationCompleted == null)) {
                this.OutInAreaStatisticOperationCompleted = new System.Threading.SendOrPostCallback(this.OnOutInAreaStatisticOperationCompleted);
            }
            this.InvokeAsync("OutInAreaStatistic", new object[] {
                        trackData,
                        areaData}, this.OutInAreaStatisticOperationCompleted, userState);
        }
        
        private void OnOutInAreaStatisticOperationCompleted(object arg) {
            if ((this.OutInAreaStatisticCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.OutInAreaStatisticCompleted(this, new OutInAreaStatisticCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.7.3190.0")]
    public delegate void OutInAreaStatisticCompletedEventHandler(object sender, OutInAreaStatisticCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.7.3190.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class OutInAreaStatisticCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal OutInAreaStatisticCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
