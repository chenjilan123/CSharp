...
namespace CSharp.Excel
{
    ...
    public class NPOIExcelExporter
    {
        ...
        public NPOIExcelExporter Export()
        {
            //1 创建工作簿
            //2 创建工作表
            //3 创建单元格
        ...
        #region 创建Excel
        public NPOIExcelExporter CreaterExcel()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public NPOIExcelExporter CreateSummary()
        {
            //OLE2格式，都可以拥有这两个头信息
        ...
        #region 创建单元格
        public NPOIExcelExporter CreateCell()
        {
            var workbook = CreateWorkbooWithSheet();
        ...
        /// </summary>
        /// <returns></returns>
        public NPOIExcelExporter CreateComment()
        {
            var workbook = CreateWorkbooWithSheet();
        ...
        #region 设置单元格格式
        public NPOIExcelExporter SetCellFormat()
        {
            var workbook = CreateWorkbooWithSheet();
        ...
        public void CreateWorkBook()
        {
            ...
            foreach (var filePath in files)
            {
                ...
                ISheet s1 = workbook.GetSheetAt(1);
